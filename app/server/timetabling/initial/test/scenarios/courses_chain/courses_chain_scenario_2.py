...
courses = [
    Course(id=0, discipline=0, lecturer=0, group=0, chain_priority=1, **course_params),
    Course(id=1, discipline=1, lecturer=1, group=1, chain_priority=1, **course_params),
    Course(id=2, discipline=2, lecturer=2, group=2, chain_priority=1, **course_params),
    Course(id=3, discipline=3, lecturer=3, group=3, chain_priority=0, **course_params),
    Course(id=4, discipline=4, lecturer=4, group=4, chain_priority=0, **course_params),
