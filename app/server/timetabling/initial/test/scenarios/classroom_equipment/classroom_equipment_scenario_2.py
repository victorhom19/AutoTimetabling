...
classroom_equipment = [
    ClassroomEquipment(id=0, classroom=0, equipment_type=0, amount=5),
    ClassroomEquipment(id=1, classroom=0, equipment_type=1, amount=20)
]

required_equipment = [
    RequiredEquipment(id=i, course=i, equipment_type=0, amount=10)
    for i in range(CPD)
]
