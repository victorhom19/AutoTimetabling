...
classrooms = [
    ...
    Classroom(id=8, capacity=150),
    Classroom(id=9, capacity=150),
    Classroom(id=10, capacity=150),
    Classroom(id=11, capacity=150),
    Classroom(id=12, capacity=150),
]
...
timeslots = [
    ...
    for w in range(8) for d in range(DPW) for c in range(CPD)
]
